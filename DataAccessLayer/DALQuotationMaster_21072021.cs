            ...
            try
            {
                if (QM.PK_QTID != 0 && QM.Revise !=null /*|| QM.Revise!=""*/) // ===========Revise
                {
                   ...
                   // CMDRevisedQuotation.Parameters.AddWithValue("@FK_CMP_ID", QM.FK_CMP_ID);
                    ...
                    {
                        CMDRevisedQuotation.Parameters.AddWithValue("@ExclusionCheckBox", "1");
                    }
                    else
                    {
                        CMDRevisedQuotation.Parameters.AddWithValue("@ExclusionCheckBox", "0");
                    }
                ...
                if (QM.QuotationNumber != "" && QM.QuotationNumber != null && QM.Revise == null || QM.Revise == "") //=============Update
                {
                    ...
                    //CMDUpdateQuotation.Parameters.AddWithValue("@DEstimatedAmount", QM.DEstimatedAmount);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@Dcurrency", QM.Dcurrency);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@DExchangeRate", QM.DExchangeRate);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@DTotalAmount", QM.DTotalAmount);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@IEstimatedAmount", QM.IEstimatedAmount);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@Icurrency", QM.Icurrency);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@IExchangeRate", QM.IExchangeRate);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@ITotalAmount", QM.ITotalAmount);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@distance", QM.Distance);
                    ...
                    //CMDUpdateQuotation.Parameters.AddWithValue("@OrderRate", QM.OrderRate);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@Estimate_ManMonth", QM.Estimate_ManMonth);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@Estimate_ManDays_ManMonth", QM.Estimate_ManDays_ManMonth);
                    //CMDUpdateQuotation.Parameters.AddWithValue("@OrderType", QM.OrderType);
                    CMDUpdateQuotation.Parameters.AddWithValue("@Exclusion", QM.Exclusion);
                    //if(QM.ExclusionCheckBox==true)
                    //{
                    //    CMDUpdateQuotation.Parameters.AddWithValue("@ExclusionCheckBox", "1");
                    //}
                    //else
                    //{
                    //    CMDUpdateQuotation.Parameters.AddWithValue("@ExclusionCheckBox","0");
                    //}
