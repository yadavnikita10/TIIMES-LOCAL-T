    ...
    public class DALInspectionVisitReport
    {
        ...
        public string InsertUpdateConclousion(InspectionvisitReportModel CPM)
        {
            ...
            try
            {
                if (CPM.PK_IVR_ID == 0)
                {
                    ...
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@acceptedStages", CPM.acceptedStages);
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@acceptedItems", CPM.acceptedItems);
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@NonacceptedStages", CPM.NonacceptedStages);
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@NonacceptedItems", CPM.NonacceptedItems);
        ...
        public string InsertAreasOfConcern(InspectionvisitReportModel CPM)
        {
            ...
            try
            {
                if (CPM.PkId != "" && CPM.PkId != null)
                {
                    ...
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@Category", CPM.Category);
        ...
        public string CloseConcern(InspectionvisitReportModel CPM)
        {
            ...
            try
            {
                ...
                CMDInsertUpdatebranch.Parameters.AddWithValue("@Type", CPM.Type);
                CMDInsertUpdatebranch.Parameters.AddWithValue("@CreatedBy", Convert.ToString(System.Web.HttpContext.Current.Session["UserIDs"]));
                CMDInsertUpdatebranch.Parameters.AddWithValue("@mitigateddate", Convert.ToDateTime(CPM.Mitigateddate));
                Result = CMDInsertUpdatebranch.ExecuteNonQuery().ToString();
        ...
        public DataTable GetAllReportByUser_()//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
        ...
        //added by nikita on 26092023
        public DataTable GetAllReportByUserDatewise_(string fromdate, string todate)//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
                ...
                CMDGetDdlLst.Parameters.AddWithValue("@FromDate", DateTime.ParseExact(DateTime.ParseExact(fromdate, "dd/mm/yyyy", provider).ToString("mm/dd/yyyy"), "MM/dd/yyyy", theCultureInfo));
                CMDGetDdlLst.Parameters.AddWithValue("@ToDate", DateTime.ParseExact(DateTime.ParseExact(todate, "dd/mm/yyyy", provider).ToString("mm/dd/yyyy"), "MM/dd/yyyy", theCultureInfo));
        ...
        public string InsertPendingActivities(InspectionvisitReportModel CPM)
        {
            ...
            try
            {
                if (CPM.PkId != "" && CPM.PkId != null)//Update
                {
                    ...
                    CMDInsertUpdatebranch.CommandType = CommandType.StoredProcedure;
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@SP_Type", 24);
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@Areas_Of_Concerns", CPM.Pending_Activites);
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@PkId", CPM.PkId);
                    Result = CMDInsertUpdatebranch.ExecuteNonQuery().ToString();
                }
                else
        ...
        public DataSet EditInspectionVisitReportByPKCallID(int? PK_Call_ID)
        {
            ...
            try
            {
                ...
                CMDEditContact.CommandTimeout = 120;
        ...
        public DataTable GetPOItemNo(int? PK_IVR_ID)//Get All DropDownlist 
        {
            ...
            try
            {
                ...
                CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", "92");
        ...
        public string Updateareaconcern(InspectionvisitReportModel IR)
        {
            ...
            try
            {
                ...
                CMDInsertUpdatebranch.Parameters.AddWithValue("@PK_IVR_ID", IR.PK_IVR_ID);
        ...
        public DataTable UpdateIVRData(int? pkCallID, string PoDescription,int IsIssuePending )//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
                ...
                CMDGetDdlLst.Parameters.AddWithValue("@IsIssuePending", IsIssuePending);
        ...
        public string InsertUpdateItemDescription(ItemDescriptionModel CPM)
        {
            ...
            try
            {
                if (CPM.PK_ItemD_Id == 0)
                {
                    ...
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@HeatNumber", CPM.HeatNumber);
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@TotalQuantity", CPM.TotalQuantity);
                ...
                else
                {
                    ...
                    CMDInsertUpdateItemDescription.Parameters.AddWithValue("@HeatNumber", CPM.HeatNumber);
                    CMDInsertUpdateItemDescription.Parameters.AddWithValue("@TotalQuantity", CPM.TotalQuantity);
        ...
        public string InsertUpdateReport(ReportModel CPM)
        {
            ...
            try
            {
                if (CPM.PK_RM_ID == 0)
                {
                    ...
                    Result = CMDInsertUpdatebranch.ExecuteNonQuery().ToString();
                    ReturnId = Convert.ToString(CMDInsertUpdatebranch.Parameters["@GetReportId"].Value.ToString());
                    System.Web.HttpContext.Current.Session["GetReportId"] = ReturnId;
                }
                else
                {
        ...
        public DataTable GetAllReportByUser()//Get All DropDownlist 
        {
            ...
            try
            {
               ...
               // CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", 10);
                CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", 90);
                CMDGetDdlLst.Parameters.AddWithValue("@CreatedBy", Convert.ToString(System.Web.HttpContext.Current.Session["UserIDs"]));
                SqlDataAdapter SDAGetDdlLst = new SqlDataAdapter(CMDGetDdlLst);
                SDAGetDdlLst.Fill(DSGetddlList);
            }
        ...
        public string InsertUpdateInspectionvisitTime(InspectionvisitReportModel CPM)
        {
            ...
            try
            {
                    ...
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@Intime", CPM.Intime);
                    CMDInsertUpdatebranch.Parameters.AddWithValue("@Outtime", CPM.Outtime);
                CMDInsertUpdatebranch.Parameters.AddWithValue("@CallNo", CPM.Call_No);
                Result = CMDInsertUpdatebranch.ExecuteNonQuery().ToString();
            }
            catch (Exception ex)
            {
        ...
        public List<ConclusionMaster> GetConclusionList()
        {
        //    DataTable dt = new DataTable();
        //    SqlCommand CMDGetEdit = new SqlCommand("SP_InspectionVisitReport", con);
        //    CMDGetEdit.CommandType = CommandType.StoredProcedure;
        //    CMDGetEdit.CommandTimeout = 1000000;
        //    CMDGetEdit.Parameters.AddWithValue("@SP_Type", 68);
        ...
        //    return dt;
            ...
            DataTable DTEMDashBoard = new DataTable();
            List<ConclusionMaster> lstEnquiryDashB = new List<ConclusionMaster>();
            try
            {
                SqlCommand CMDGetEnquriy = new SqlCommand("SP_InspectionVisitReport", con);
                CMDGetEnquriy.CommandType = CommandType.StoredProcedure;
                CMDGetEnquriy.CommandTimeout = 1000000;
                CMDGetEnquriy.Parameters.AddWithValue("@SP_Type", 68);
        ...
        public DataTable EditConSubUploadedFile2(int? ID, int? PK_call_id)
        {
            DataTable DTEditUploadedFile = new DataTable();
            try
            {
                SqlCommand CMDEditUploadedFile = new SqlCommand("SP_DetailsUploadedFile", con);
                CMDEditUploadedFile.CommandType = CommandType.StoredProcedure;
                CMDEditUploadedFile.Parameters.AddWithValue("@SP_Type", "2N");
                CMDEditUploadedFile.Parameters.AddWithValue("@FK_SJID", ID);
                CMDEditUploadedFile.Parameters.AddWithValue("@PK_call_id", PK_call_id);
        ...
        public DataTable GetFileContentdetails(int? EQ_ID)
        {
            DataTable DTEditUploadedFile = new DataTable();
        ...
        public DataTable GetConFileExtdetails(string FileID)
        {
            DataTable DTGetFileExtenstion = new DataTable();
            try
            {
                SqlCommand CMDGetExtenstion = new SqlCommand("SP_DetailsUploadedFile", con);
                CMDGetExtenstion.CommandType = CommandType.StoredProcedure;
                CMDGetExtenstion.Parameters.AddWithValue("@SP_Type", 4);
                CMDGetExtenstion.Parameters.AddWithValue("@FileID", FileID);
                CMDGetExtenstion.Parameters.AddWithValue("@CreatedBy", Convert.ToString(System.Web.HttpContext.Current.Session["UserIDs"]));
        ...
        public string DeleteConUploadedFiledetails(string FileID)
        {
            string Result = string.Empty;
            con.Open();
            try
            {
                SqlCommand CMDDeleteUploadedFile = new SqlCommand("SP_DetailsUploadedFile", con);
                CMDDeleteUploadedFile.CommandType = CommandType.StoredProcedure;
                CMDDeleteUploadedFile.Parameters.AddWithValue("@SP_Type", 3);
                CMDDeleteUploadedFile.Parameters.AddWithValue("@FK_SJID", FileID);
                CMDDeleteUploadedFile.Parameters.AddWithValue("@CreatedBy", Convert.ToString(System.Web.HttpContext.Current.Session["UserIDs"]));
                Result = CMDDeleteUploadedFile.ExecuteNonQuery().ToString();
            }
            catch (Exception ex)
        ...
        #region Areas of concern On PDF
        public DataTable GetAreasOfConcernOnPDF(int? PK_Call_ID)//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
        ...
        public DataTable CheckOPE_ApprovalData(string pkcallid)//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
        ...
        //added by satish yadav
        public DataTable GetAutoSuggestionDetails(string Result, string Product)
        {
            DataTable Suggestdtbl = new DataTable();
            try
            {
                SqlCommand CMDGetDdlLst = new SqlCommand("Sp_GetSuggestion", con);
                CMDGetDdlLst.CommandType = CommandType.StoredProcedure;
                CMDGetDdlLst.Parameters.AddWithValue("@Sp_Type", "1");
                CMDGetDdlLst.Parameters.AddWithValue("@Query", Result);
                CMDGetDdlLst.Parameters.AddWithValue("@Product", Product);
                SqlDataAdapter SDAGetDdlLst = new SqlDataAdapter(CMDGetDdlLst);
                SDAGetDdlLst.Fill(Suggestdtbl);
            }
            catch (Exception ex)
            {
                string Error = ex.Message.ToString();
        ...
        public DataTable GetInspectionVisit(int PK_CALL_ID)
        {
            DataTable Suggestdtbl = new DataTable();
            try
            {
        ...
        public DataTable GetInspectionIRN(int PK_IVR_ID)
        {
            DataTable Suggestdtbl = new DataTable();
            try
            {
        ...
        public List<NameStatusEngineering> GetitemName(int? pk_call_id)// Binding Sales Masters DashBoard of Master Page 
        {
            DataTable DTEMDashBoard = new DataTable();
            ...
            try
            {
                ...
                CMDGetEnquriy.CommandType = CommandType.StoredProcedure;
                CMDGetEnquriy.CommandTimeout = 1000000;
                CMDGetEnquriy.Parameters.AddWithValue("@SP_Type", 83);
                CMDGetEnquriy.Parameters.AddWithValue("@PK_call_id", pk_call_id);
        ...
        public DataTable GetDatewiseReportByUser(string fromdate, string todate)//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
        ...
        public List<NameStatusEngineering> GetList()
        {
            ...
            try
            {
                ...
                CMDGetEnquriy.CommandType = CommandType.StoredProcedure;
                CMDGetEnquriy.CommandTimeout = 1000000;
                CMDGetEnquriy.Parameters.AddWithValue("@SP_Type", 72);
        ...
        public DataTable GetItemMaster()//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
                SqlCommand CMDGetDdlLst = new SqlCommand("SP_InspectionVisitReport", con);
                CMDGetDdlLst.CommandType = CommandType.StoredProcedure;
                CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", "72");
                //CMDGetDdlLst.Parameters.AddWithValue("@PK_Call_Id", PK_Call_Id);
                SqlDataAdapter SDAGetDdlLst = new SqlDataAdapter(CMDGetDdlLst);
                SDAGetDdlLst.Fill(DSGetddlList);
            }
        ...
        public DataTable GetAttachmentsData(int? pk_ivr_id)//Get All DropDownlist 
        {
            ...
            try
            {
                SqlCommand CMDGetDdlLst = new SqlCommand("Sp_GetAttachmentData", con);
                CMDGetDdlLst.CommandType = CommandType.StoredProcedure;
                CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", "Nikita_");
        ...
        public DataTable DeleteEmail(int? pk_call_id, string EmailType, string Name, string Email)//Get All DropDownlist 
        {
            ...
            try
            {
                SqlCommand CMDGetDdlLst = new SqlCommand("Sp_DeleteEmailData", con);
                CMDGetDdlLst.CommandType = CommandType.StoredProcedure;
                if (EmailType == "TUV")
                {
                    CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", "1");
        ...
        public DataTable updateIscomfirmation(int? PK_Call_ID, ReportModel CPM)//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
                SqlCommand CMDGetDdlLst = new SqlCommand("SP_InspectionVisitReport", con);
                CMDGetDdlLst.CommandType = CommandType.StoredProcedure;
                CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", "73");
                CMDGetDdlLst.Parameters.AddWithValue("@PK_Call_ID", PK_Call_ID);
        ...
        public DataTable updateIscomfirmation_ReportMaster(string Pk_RM_ID, InspectionvisitReportModel IVR)//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
                SqlCommand CMDGetDdlLst = new SqlCommand("SP_InspectionVisitReport", con);
                CMDGetDdlLst.CommandType = CommandType.StoredProcedure;
                CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", "74");
                CMDGetDdlLst.Parameters.AddWithValue("@PK_Call_ID", Pk_RM_ID);
                CMDGetDdlLst.Parameters.AddWithValue("@IsComfirmation", IVR.IsComfirmation);
                SqlDataAdapter SDAGetDdlLst = new SqlDataAdapter(CMDGetDdlLst);
                SDAGetDdlLst.Fill(DSGetddlList);
            }
            catch (Exception ex)
        ...
        public DataTable areaofconcerncheck(int pk_call_id)//Get All DropDownlist 
        {
            ...
            try
            {
                ...
                CMDGetDdlLst.CommandType = CommandType.StoredProcedure;
                CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", "32NV");
        ...
        public DataSet GetIVRdata(int? PK_Call_ID)
        {
            DataSet DTEditContact = new DataSet();
            try
            {
                SqlCommand CMDEditContact = new SqlCommand("SP_InspectionVisitReport", con);
                CMDEditContact.CommandType = CommandType.StoredProcedure;
                CMDEditContact.Parameters.AddWithValue("@SP_Type", "100N");
                CMDEditContact.Parameters.AddWithValue("@PK_Call_ID", PK_Call_ID);
                CMDEditContact.Parameters.AddWithValue("@CreatedBy", Convert.ToString(System.Web.HttpContext.Current.Session["UserIDs"]));
                SqlDataAdapter SDAEditContact = new SqlDataAdapter(CMDEditContact);
                SDAEditContact.Fill(DTEditContact);
        ...
        public DataTable areaofconcerncheck_(int pk_call_id)//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
        ...
        public DataSet AllPreviousConcern_Subjob(int? PK_SubJob_Id)
        {
            DataSet DTEditContact = new DataSet();
            try
            {
        ...
        public DataSet AllPreviousCloseConcern_Subjob(int? PK_SubJob_Id)
        {
            DataSet DTEditContact = new DataSet();
            try
            {
        ...
        public DataTable GetDataForExportToExcelAllConcern_Subjob(int? PK_SubJob_Id)//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            try
            {
        ...
        public DataTable BulkInsertToStaging(List<VisitMonitoringRecord> data, string PK_CALL_ID, string Additionalcomment, bool IsComfirmation, int PK_IVR_ID, int PK_RM_ID,bool ShopApproved, string ShopApproved_Number, string ValidityDate,string VendorName,bool BoilerComponentManufacturer, bool BolierOwner, bool BoilerManufacturer)
        {
            ...
            DateTime? confirmationDate = IsComfirmation ? DateTime.Now : (DateTime?)null;
                ...
                {
                    if (DateTime.TryParse(ValidityDate, out tempDate))
                    {
                        validityDateParsed = tempDate;
                    }
                }
        ...
        public DataTable BulkInsertToDiary(List<VisitMonitoringRecord> data, string pk_call_id, bool BoilerComponentManufacturer, bool BolierOwner, bool BoilerManufacturer, bool IsComfirmation, int PK_IVR_ID, int PK_RM_ID, bool ShopApproved, string ShopApproved_Number, string ValidityDate)
        {
            ...
            {
                dt.Columns.Add("Date", typeof(string));
                dt.Columns.Add("Inspection_Authority_ReferenceNo", typeof(string));
                dt.Columns.Add("Boliers_Maker_No", typeof(string));
                dt.Columns.Add("Form_no_Certificate_No", typeof(string));
                dt.Columns.Add("Quality_offered_Final_Inspection", typeof(string));
                dt.Columns.Add("Size", typeof(string));
                dt.Columns.Add("No_For_lot_invoicing", typeof(string));
                dt.Columns.Add("Activities_Events", typeof(string));
                dt.Columns.Add("Createdby", typeof(string));
                dt.Columns.Add("PK_Call_ID", typeof(string));
                ...
                {
                    dt.Rows.Add(
                        record.Date ?? (object)DBNull.Value,
                        record.Inspection_Authority_ReferenceNo ?? (object)DBNull.Value,
                        record.Boliers_Maker_No ?? (object)DBNull.Value,
                        record.Form_no_Certificate_No ?? (object)DBNull.Value,
                        record.Quality_offered_Final_Inspection ?? (object)DBNull.Value,
                        record.Size ?? (object)DBNull.Value,
                        record.No_For_lot_invoicing ?? (object)DBNull.Value,
                        record.Activities_Events ?? (object)DBNull.Value,
                        createdBy,
                        pk_call_id,
                        createdDateTime,
                        BolierOwner,
                     ...
                     validityDateParsed ?? (object)DBNull.Value,
                      ...
                      record.Activities_Events_Value
                    );
                }
                ...
                using (SqlBulkCopy bulkCopy = new SqlBulkCopy(con))
                {
                    bulkCopy.DestinationTableName = "dbo.tbl_VisitPersonDiary";
                    bulkCopy.ColumnMappings.Add("Date", "Date");
                    bulkCopy.ColumnMappings.Add("Inspection_Authority_ReferenceNo", "Inspection_Authority_ReferenceNo");
                    bulkCopy.ColumnMappings.Add("Boliers_Maker_No", "Boliers_Maker_No");
                    bulkCopy.ColumnMappings.Add("Form_no_Certificate_No", "Form_no_Certificate_No");
                    bulkCopy.ColumnMappings.Add("Quality_offered_Final_Inspection", "Quality_offered_Final_Inspection");
                    bulkCopy.ColumnMappings.Add("Size", "Size");
                    bulkCopy.ColumnMappings.Add("No_For_lot_invoicing", "No_For_lot_invoicing");
                    bulkCopy.ColumnMappings.Add("Activities_Events", "Activities_Events");
                    bulkCopy.ColumnMappings.Add("Createdby", "Createdby");
                    bulkCopy.ColumnMappings.Add("PK_Call_ID", "PK_Call_ID");
        ...
        public List<VisitMonitoringRecord> GetMonitoringData()//Get All DropDownlist 
        {
            ...
            try
            {
                ...
                if (DSGetddlList.Rows.Count > 0)
                {
                    foreach (DataRow dr in DSGetddlList.Rows)
                    {
                        getdata.Add(
        ...
        public List<VisitMonitoringRecord> GetPersonalDiaryData()//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            List<VisitMonitoringRecord> getdata = new List<VisitMonitoringRecord>();
            try
        ...
        public List<VisitMonitoringRecord> MISGetMonitoringData()//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            List<VisitMonitoringRecord> getdata = new List<VisitMonitoringRecord>();
            try
        ...
        public List<VisitMonitoringRecord> MISGetMonitoringDataDatewise(string fromdate, string todate)//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            List<VisitMonitoringRecord> getdata = new List<VisitMonitoringRecord>();
            try
        ...
        public List<VisitMonitoringRecord> MISGetPersonalDiaryData()//Get All DropDownlist 
        {
            DataTable DSGetddlList = new DataTable();
            List<VisitMonitoringRecord> getdata = new List<VisitMonitoringRecord>();
            try
        ...
        public List<VisitMonitoringRecord> MISGetPersonalDiaryDataDatewise(string FromDate, string ToDate,string vendorname,string Inspector)//Get All DropDownlist 
        {
            ...
            try
            {
                ...
                CMDGetDdlLst.Parameters.AddWithValue("@InspectorName", Inspector);
                SqlDataAdapter SDAGetDdlLst = new SqlDataAdapter(CMDGetDdlLst);
                SDAGetDdlLst.Fill(DSGetddlList);
