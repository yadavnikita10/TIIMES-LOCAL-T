...
namespace TuvVision.DataAccessLayer
{
    public class DALUsers
    {
        ...
        */
        ...
        public string InsertCVData(string UserID, string Inspection, string ExpertiseSummary, bool IsInspectionCheck, DataTable Employmentdata, DataTable Projectdata, DataTable Trainingdata)
        {
            string Result1 = string.Empty;
            con.Open();
            try
        ...
        public void UpdateCVDownloadDate(string UserID)
        {
            con.Open();
            try
            {
