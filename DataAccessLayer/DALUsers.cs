        ...
        */
        ...
        public string InsertUpdateUsers(Users URS)
        {
            ...
            try
            {
                if (URS.PK_UserID != null && URS.PK_UserID != "")
                {
                    if (URS.LoginUserRoleId == 61 || URS.LoginUserRoleId == 62)
                    {
                        ...
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@Nationality", URS.Nationality);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@Location", URS.Location);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@PFUANNumber", URS.PFUANNumber);

                        //added by shrutika salve 28022024
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@CoreFieldOfStudy", URS.CoreField);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@DisplayName", URS.DisplayName);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@EmployeeRollNo", URS.EmpRollNo);
                    ...
                    else
                    {
                        ...
                        //added by shrutika salve 28022024
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@CoreFieldOfStudy", URS.CoreField);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@SpecialServices", URS.specialservices);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@Dom_Inter", URS.Dom_Inter);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@DisplayName", URS.DisplayName);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@LpgGasCylinder", URS.LpgGasCylinder);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@Nationality", URS.Nationality);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@Location", URS.Location);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@EmployeeRollNo", URS.EmpRollNo);
                        CMDInsertUpdateUsers.Parameters.AddWithValue("@S1Check", URS.S1Check);
        ...
        public List<Nationality> GetNationality()// Binding Sales Masters DashBoard of Master Page 
        {
            DataTable DTEMDashBoard = new DataTable();
            List<Nationality> lstEnquiryDashB = new List<Nationality>();
            try
            {
                SqlCommand CMDGetEnquriy = new SqlCommand("SP_CreateUser", con);
                CMDGetEnquriy.CommandType = CommandType.StoredProcedure;
                ...
                if (DTEMDashBoard.Rows.Count > 0)
                {
                    foreach (DataRow dr in DTEMDashBoard.Rows)
                    {
                        lstEnquiryDashB.Add(
                           new Nationality
                           {
                               Nationality_ID = Convert.ToInt32(dr["Nationality_ID"]),
                               Nationality_ = Convert.ToString(dr["Nationality"]),
                           }
                         );
                    }
                }
        ...
        public DataTable GetUserMis() //User Role DashBoard
        {
            ...
            try
            {
                ...
                CMDRoleDashBoard.CommandTimeout = 100000;
                CMDRoleDashBoard.Parameters.AddWithValue("@SP_Type", 2);
                CMDRoleDashBoard.Parameters.AddWithValue("@UserID", Convert.ToString(System.Web.HttpContext.Current.Session["UserIDs"]));
                SqlDataAdapter SDADashBoardData = new SqlDataAdapter(CMDRoleDashBoard);
                SDADashBoardData.Fill(DTGetRoleDashBoard);
            }
            catch (Exception ex)
        ...
        public DataTable GetAtt(string Id,int LoginUserRoleId)
        {
            DataTable DTEditUsers = new DataTable();
            try
            {
                ...
                CMDEditUsers.Parameters.AddWithValue("@FK_userid", Id);
                CMDEditUsers.Parameters.AddWithValue("@LoginRoleID", LoginUserRoleId);
        ...
        public DataTable GetEyeTest(string Id)
        {
            ...
            try
            {
                SqlCommand CMDEditUsers = new SqlCommand("SP_UserCreationAttachment", con);
                CMDEditUsers.CommandType = CommandType.StoredProcedure;
                CMDEditUsers.Parameters.AddWithValue("@SP_Type", 13);
                CMDEditUsers.Parameters.AddWithValue("@FK_userid", Id);
                SqlDataAdapter SDAEditUsers = new SqlDataAdapter(CMDEditUsers);
                SDAEditUsers.Fill(DTEditUsers);
            }
        ...
        public List<CostCenterModel> GetDocumentType(int LoginUserRoleId)// Binding Sales Masters DashBoard of Master Page 
        {
            DataTable DTEMDashBoard = new DataTable();
            List<CostCenterModel> lstEnquiryDashB = new List<CostCenterModel>();
            ...
            try
            {
                ...
                CMDGetEnquriy.Parameters.AddWithValue("@LoginRoleID", LoginUserRoleId);
                SqlDataAdapter SDAGetEnquiry = new SqlDataAdapter(CMDGetEnquriy);
                SDAGetEnquiry.Fill(DTEMDashBoard);
        ...
        public DataTable CheckBranchDetails(string CostCentreID)
        {
            DataTable DTScripName = new DataTable();
            ...
            try
            {
                ...
                CMDSearchNameCode.CommandType = CommandType.StoredProcedure;
                CMDSearchNameCode.CommandTimeout = 1000000000;
                CMDSearchNameCode.Parameters.AddWithValue("@SP_Type", 33);
                CMDSearchNameCode.Parameters.AddWithValue("@PKID", CostCentreID);
        ...
        public DataTable GetOrgChangeData() //User Role DashBoard
        {
            ...
            try
            {
                ...
                CMDRoleDashBoard.CommandType = CommandType.StoredProcedure;
                CMDRoleDashBoard.CommandTimeout = 100000;
                CMDRoleDashBoard.Parameters.AddWithValue("@SP_Type", 34);
                SqlDataAdapter SDADashBoardData = new SqlDataAdapter(CMDRoleDashBoard);
                SDADashBoardData.Fill(DTGetRoleDashBoard);
            }
            catch (Exception ex)
        ...
        public string InsertCVData(string UserID, string Inspection, string ExpertiseSummary, bool IsInspectionCheck, DataTable Employmentdata, DataTable Projectdata, DataTable Trainingdata, DataTable Achievementdata)
        {
            string Result1 = string.Empty;
            con.Open();
            try
            {
                ...
                cmd.Parameters.AddWithValue("@IsInspectionCheck", IsInspectionCheck);
                ...
                //comment by Nikita Yadav 11/02/2025
                //cmd.Parameters.AddWithValue("@Ndtdata1", NdtData);
        ...
        public DataSet GetUserCV(string PK_UserID)
        {
            ...
            try
            {
                SqlCommand CMDEditUsers = new SqlCommand("SP_GetUserCV", con);
                CMDEditUsers.CommandType = CommandType.StoredProcedure;
                CMDEditUsers.Parameters.AddWithValue("@PK_UserID", PK_UserID);
        ...
        public void UpdateCVDownloadDate(string UserID, string ReportName)
        {
            con.Open();
            try
            {
                SqlCommand CMDLastLoginID = new SqlCommand("SP_UpdateCVDownloadDate", con);
                CMDLastLoginID.CommandType = CommandType.StoredProcedure;
                CMDLastLoginID.Parameters.AddWithValue("@UserID", UserID);
                CMDLastLoginID.Parameters.AddWithValue("@ReportName", ReportName);
        ...
        public string RefetchInspectionData(string UserID)
        {
            DataTable DTInspection = new DataTable();
            try
            {
                SqlCommand CMDEditUsers = new SqlCommand("SP_RefetchInspectionData", con);
                CMDEditUsers.CommandType = CommandType.StoredProcedure;
                CMDEditUsers.Parameters.AddWithValue("@UserID", UserID);

                SqlDataAdapter SDAEditUsers = new SqlDataAdapter(CMDEditUsers);
                SDAEditUsers.Fill(DTInspection);
            ...
            {
                DTInspection.Dispose();
            }

            if (DTInspection.Rows.Count > 0)
            {
                return DTInspection.Rows[0][0].ToString();
            }
            else
            {
                return "";
        ...
        public DataTable GetCVData()
        {
            DataTable DSGetActivityData = new DataTable();
            try
            {
                SqlCommand CMDGetDdlLst = new SqlCommand("SP_CVDataShow", con);
                CMDGetDdlLst.CommandType = CommandType.StoredProcedure;
                CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", "2");
                CMDGetDdlLst.Parameters.AddWithValue("@PK_UserID", System.Web.HttpContext.Current.Session["UserIDs"]);
        ...
        public void SaveCVHTML(string HTML, string UserID)
        {
            string Result1 = string.Empty;
            con.Open();
            try
            {
                SqlCommand cmd = new SqlCommand("SP_InsertCVHTML", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable SearchTermInCV(string SearchTerm)
        {
            DataTable DSGetActivityData = new DataTable();
            try
            {
                SqlCommand CMDGetDdlLst = new SqlCommand("SP_SearchTermInCV", con);
                CMDGetDdlLst.CommandType = CommandType.StoredProcedure;
                CMDGetDdlLst.Parameters.AddWithValue("@SearchTerm", SearchTerm);
                 CMDGetDdlLst.Parameters.AddWithValue("@PK_UserId", System.Web.HttpContext.Current.Session["UserIDs"]);
                //CMDGetDdlLst.Parameters.AddWithValue("@BranchName", FolderName);
                SqlDataAdapter SDAGetDdlLst = new SqlDataAdapter(CMDGetDdlLst);
                SDAGetDdlLst.Fill(DSGetActivityData);
        ...
        public string InsertEyeTest(Users URS, int UserPrimaryKey, int chkVerified)
        {
            string Result1 = string.Empty;
            con.Open();
            try
            {
                ...
                if (UserPrimaryKey > 0)
                {
                    SqlCommand CMDInsertUpdateUsers = new SqlCommand("SP_CreateUser", con);
                    CMDInsertUpdateUsers.CommandType = CommandType.StoredProcedure;
                    CMDInsertUpdateUsers.Parameters.AddWithValue("@SP_Type", "35");

                    CMDInsertUpdateUsers.Parameters.AddWithValue("@IssueBy", URS.EyeCreatedBy);
                    CMDInsertUpdateUsers.Parameters.AddWithValue("@PKID", URS.PK_ID);
                    //CMDInsertUpdateUsers.Parameters.AddWithValue("@CertIssueDate", DateTime.ParseExact(URS.CertIssueDate, "dd/MM/yyyy", theCultureInfo));
                    CMDInsertUpdateUsers.Parameters.AddWithValue("@CertIssueDate", DateTime.ParseExact(URS.EyeIssueDate, "dd/MM/yyyy", theCultureInfo));
        ...
        //added by shrutika salve check Filename 21062024
        public DataTable ChkFileDetailExistFrom(Users CPM)
        {
            DataTable DTEditContact = new DataTable();
            try
            {
                SqlCommand CMDEditContact = new SqlCommand("SP_CreateUser", con);
                CMDEditContact.CommandType = CommandType.StoredProcedure;
                CMDEditContact.Parameters.AddWithValue("@SP_Type", "36");
                CMDEditContact.Parameters.AddWithValue("@CertName", CPM.CertName);
        ...
        public string CheckCertNameExistence(Users CPM)
        {
            string result = ""; // Default to not exist
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@CertName", CPM.CertName);

                con.Open();
                result = Convert.ToString(cmd.ExecuteScalar()); // ExecuteScalar since SP returns a single value
            }
            catch (Exception ex)
            {
                string error = ex.Message.ToString();
        ...
        {
            DataTable DsFeedbackDashboard = new DataTable();

            try
            {
                SqlCommand cmd = new SqlCommand("Sp_ProCertUserValidDate", con);
        ...
        public DataSet GetEmployeeTypeLst(string UserId)
        {
            DataSet DSGetDdlList = new DataSet();
            try
            {
                ...
                CMDGetDdlLst.CommandType = CommandType.StoredProcedure;
                CMDGetDdlLst.CommandTimeout = 900000000;
                CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", "33NN");
        ...
        public DataSet GetDataExcel(string InspectorName)
        {
        ...
        public DataTable GetNdtCerts(String QT_ID)
        {
            DataTable DOrderType = new DataTable();
            try
            {
                SqlCommand CMDEditUploadedFile = new SqlCommand("SP_CreateUser", con);
                CMDEditUploadedFile.CommandType = CommandType.StoredProcedure;
                CMDEditUploadedFile.Parameters.AddWithValue("@SP_Type", "43");
                CMDEditUploadedFile.Parameters.AddWithValue("@PK_UserID", QT_ID);
                SqlDataAdapter SDAEditUploadedFile = new SqlDataAdapter(CMDEditUploadedFile);
                SDAEditUploadedFile.Fill(DOrderType);
            }
            catch (Exception ex)
