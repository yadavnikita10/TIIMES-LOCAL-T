        ...
        public string InsertUpdateJOb(JobMasters CPM, string IPath, string IPath1)
        {
            ...
            try
            {
                if (CPM.PK_JOB_ID == 0)
                {
                    ...
                    Result = InsertUpdateJOB.ExecuteNonQuery().ToString();
                    ReturnId = Convert.ToInt32(InsertUpdateJOB.Parameters["@ReturnId"].Value.ToString());
                    Result = Convert.ToString(ReturnId);
                }
                else
                {
                    ...
                    Result = InsertUpdateBranch.ExecuteNonQuery().ToString();
                }
