...
namespace TuvVision.Models
{
    public class Users
    {
        ...
        public string specialservices { get; set; }  //added by nikita on 18042024
        public string Dom_Inter { get; set; }
        public int S1Check { get; set; } //added by nikita on 12032025
        ...
        public string CBBAuthorisationNumber { get; set; }
        public string TUVIStampNo { get; set; }
        public string OPE { get; set; }
        public string ExperienceWithTUV { get; set; }
        ...
        public string CVUpdatedOn { get; set; }
        public string CVUpdatedBy { get; set; }
        public string CVDownloadedOn { get; set; }
        public string Inspection { get; set; }
        public string ExpertiseSummary { get; set; }
        public bool IsInspectionCheck { get; set; }

        //added by shrutika salve 28022024
        public string CoreField { get; set; }
        public string CVUpdate { get; set; }

        public string DisplayName { get; set; }
        public string LpgGasCylinder { get; set; }
        public string EyeIssueDate { get; set; }
        public string EyeValidTill { get; set; }

        public string EyeCertName { get; set; }
        public string EyeCreatedBy { get; set; }
        public int EPK_ID { get; set; }

        public List<Users> lstndt { get; set; }
    ...
    public class Employment
    {
        ...
        public string Nationalities1 { get; set; }
    ...
    public class ProjectCS
    {
        ...
        public string ActivityItemInspected { get; set; }
