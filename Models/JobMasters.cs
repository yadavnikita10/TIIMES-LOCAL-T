...
namespace TuvVision.Models
{
    public class JobMasters
    {
        ...
        public bool Quotationviewed { get; set; }  //added by nikita on 18062024
        public bool LegalReview { get; set; }
        public bool JobCreated { get; set; }
        public string EmpName { get; set; }
        public string Date_ { get; set; }
        public string Legalcomment { get; set; }
        public string TermsCondition { get; set; } //added by nikita on 18062024
        ...
        public string Add_SAPNumber { get; set; }
        public string Add_SAPDate { get; set; }
