...
namespace TuvVision.Models
{
    public class MISOPEReport
    {
        ...
        public string AmountClaim { get; set; }
    ...
    public class MISJobWiseTimeSheet
    {
        ...
        public string Branch_Name { get; set; }
        public string EBranch_Name { get; set; }
    ...
    public class DebitCredit
    {
        ...
        public string ESalesOrderNo { get; set; }
        public string ESOCode { get; set; }
        public string TMaterial { get; set; }
        public string TSalesOrderNo { get; set; }
        public string TSOCode { get; set; }
