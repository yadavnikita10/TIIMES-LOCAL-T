...
namespace TuvVision.Models
{
    ...
    {
        public List<Mentoring> lstCallDashBoard { get; set; }

        public List<Mentoring> lstCallDashBoard1 { get; set; }
        ...
        public List<Mentoring> Questionlist { get; set; }
        ...
        public List<Mentoring> lstQuestionrate { get; set; }
