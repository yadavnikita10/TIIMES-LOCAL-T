...
namespace TuvVision.Controllers
{
    public class UsersController : Controller
    {
            ...
            if (CustomerAppreciation.Rows.Count > 0)
            {
                foreach (DataRow dr in CustomerAppreciation.Rows)
                {
                    lstCustomerAppreciation.Add(
                       ...
                       {
                           AppreciationDate = Convert.ToString(dr["AppreciationDate"]),
        ...
        public ActionResult DownloadCV(string language, string Age, string TotalEXP, string Inspection, string ExpertiseSummary)
        {
            ...
            string I = "<img src = 'https://tiimes.tuv-india.com/Content/Sign/" + ObjModelUsers.StrIData.ToString() + "' style='height: 220px;width: 190px;margin-top: 35px;float:right' align='center'>";
            ...
            body = body.Replace("[TotalExp]", TotalEXP);
            body = body.Replace("[Inspection]", Inspection);
            ...
            DataTable EmploymentDetails = new DataTable();
            EmploymentDetails = Session["EmploymentDetails"] as DataTable;
            string StrEmployment = string.Empty;

            foreach (DataRow row in EmploymentDetails.Rows)
            {

                StrEmployment = StrEmployment + "<div class=\"col-md-12 row\"><div class=\"col-md-3\"><b>Period</b></div><b>:</b><div class=\"col-md-8\">"
                    + row["Period"].ToString() + "</div></div><div class=\"col-md-12 row\"><div class=\"col-md-3\"><b>EmployerName</b></div><b>:</b><div class=\"col-md-8\">"
                    ...
                    + row["Designation"].ToString() + "</div></div><div class=\"col-md-12 row\"><div class=\"col-md-3\"><b>Responsibilities</b></div><b>:</b><div class=\"col-md-8\">"
            ...
            DataTable ProjectDetails = new DataTable();
            ProjectDetails = Session["ProjectDetails"] as DataTable;
            string StrProject = string.Empty;

            StrProject = "<div class=\"col-md-12\"><table id=\"ProjectTable\" cellpadding=\"1\" cellspacing=\"1\" border=\"1\" width=\"100% \"><thead><tr><th>Project /Period /Employer</th><th>Details of Activity and Item Inspected</th><th>Codes /Standards /MOC</th><th>Customer /Manufacturer /End User Name</th></tr></thead>" + ""
                    + "<tbody>";

            foreach (DataRow row in ProjectDetails.Rows)
            {
                StrProject = StrProject + "<tr><td>" + row["Project"].ToString() + " </td><td> " + row["ActivityItemInspected"].ToString() + "</td><td>" + row["Codes"].ToString()
                    + " </td><td> " + row["EndUserName"].ToString() + "</td></tr>";
            }
            ...
            DataTable TrainingDetails = new DataTable();
            TrainingDetails = Session["TrainingDetails"] as DataTable;
            ...
            foreach (DataRow row in TrainingDetails.Rows)
            {
            ...
            StrAchievement = "<div class=\"col-md-12\"><table cellpadding=\"1\" cellspacing=\"1\" border=\"1\" width=\"100% \"><thead><tr><th>Date</th><th>Description</th></tr></thead>" + ""
                    + "<tbody>";

            foreach (DataRow row in AchievementDetails.Rows)
            {
                StrAchievement = StrAchievement + "<tr><td>" + row["AppreciationDate"].ToString() + " </td><td> " + row["Description"].ToString() + "</td></tr>";
            }
            ...
            _Header = _Header.Replace("[TotalExp]", TotalEXP);
            ...
            bool IsInspectionCheck = Convert.ToBoolean(ObjModelUsers.IsInspectionCheck);

            if (!IsInspectionCheck)
            {
            ...
            if (TrainingDetails.Rows.Count == 0 && TUVTrainingDetails.Rows.Count == 0)
            {
            ...
            string ReportName = ObjModelUsers.TUVUIN + ".pdf";
            ...
            objDalCreateUser.UpdateCVDownloadDate(UserID);
   ...
   */
        ...
        */
        ...
        [HttpPost]
        public ActionResult InsertCV(string Inspection, string ExpertiseSummary, bool IsInspectionCheck, string[][] EmploymentDetails, string[][] ProjectDetails, string[][] TrainingDetails)
        {
            try
            {
                ...
                objDalCreateUser.InsertCVData(UserID, Inspection, ExpertiseSummary, IsInspectionCheck, Employmentdata, Projectdata, Trainingdata);
            }
            catch (Exception ex)
            {
