...
{
    public class NonInspectionActivityController : Controller
    {
        ...
        // GET: NonInspectionActivity
        public ActionResult NonInspectionActivity(NonInspectionActivity n,int ? id, String AddExpense1)
        {
           ...
           // ds = objNIA.GetData();
            if (ds.Tables.Count > 0)
            {
                ...
                if (dss.Tables[0].Rows.Count > 0)
                {
                    ...
                    //model.StartDate = dss.Tables[0].Rows[0]["StartDate"].ToString();
                    //model.EndDate = dss.Tables[0].Rows[0]["EndDate"].ToString();
                    //    model.StartDate = Convert.ToString(dss.Tables[0].Rows[0]["StartDate"]);
                    //   model.EndDate = Convert.ToString(dss.Tables[0].Rows[0]["EndDate"]);=
                    //objModel.DateSE = Convert.ToString(dss.Tables[0].Rows[0]["DateSE"]);
                    objModel.StartDate = Convert.ToString(dss.Tables[0].Rows[0]["DateSE"]);
                    objModel.EndDate = Convert.ToString(dss.Tables[0].Rows[0]["DateSE"]);
                    ...
                    objModel.CostCenter = dss.Tables[0].Rows[0]["CostCenter_id"].ToString();  //added by nikita on 30042024
                    objModel.CostCenter_name = dss.Tables[0].Rows[0]["Cost_Center_name"].ToString();  //added by nikita on 30042024
                ...
                foreach (DataRow dr in ds.Tables[0].Rows) // loop for adding add from dataset to list<modeldata>  
                {
                    lmd.Add(new NonInspectionActivity
                    {
                        ...
                        CostCenter_name = Convert.ToString(dr["Cost_Center_name"]), //added by nikita on 30042024
                        ...
                        if (DTValidateTT.Tables[1].Rows.Count > 0) //// Leave Checking
                        {
                            if (Convert.ToInt32(DTValidateTT.Tables[1].Rows[0][0].ToString()) > 0)
                            {
                                /* if (TempData["Error"] != null)
                                {
                                    ...
                                    {
                                        TempData["Error"] = "Leave has been applied for " + StDt.ToString("dd/MM/yyyy");

                                    }
                                    else
                                    {
                                        TempData["Error"] = TempData["Error"] + "," + StDt.ToString("dd/MM/yyyy");
                                    }
                                }
                                else
                                {
                                    ...
                                    /* if (TempData["Error"] != null)
                                     {
                                         ...
                                         {
                                             if(TempData["Error"].ToString().Contains("24 Hrs"))
                                                 TempData["Error"] = TempData["Error"] + " " + StDt.ToString("dd/MM/yyyy");
                                             else
                                                 TempData["Error"] = TempData["Error"] + "\n" + "You have excided 24 hrs for the day of " + StDt.ToString("dd/MM/yyyy");
                                         }
                                     }
                                     else
                                     {
        ...
        public ActionResult ListNonInspectionActivity(NonInspectionActivity n ,FormCollection fc)
        {
           ...
           /// if((fc["FromD"] != null && fc["FromD"] != string.Empty) && (fc["ToD"] != null && fc["ToD"] != string.Empty) )
            ...
            return RedirectToAction("NonInspectionActivity", n);
            return View(objModel);
    ...
    */
        ...
        //    try
        //    {
        //        /// if (ActType.ToUpper() == "PROJECT COORDINATION" || ActType.ToUpper() == "QA ACTIVITY - PROJECT")
        //        //if (ActType.ToUpper() == "10" || ActType.ToUpper() == "20")
        //        if (ActType.ToUpper() == "06" || ActType.ToUpper() == "16" || ActType.ToUpper() == "27" || ActType.ToUpper() == "44" || ActType.ToUpper() == "45" || ActType.ToUpper() == "43" || ActType.ToUpper() == "46"||ActType.ToUpper() == "03"|| ActType.ToUpper() == "47" || ActType.ToUpper() == "37")
        //        {
        //                    //   string[] strJobNo = JobNo.Split(',');

        //                    // for (int cnt = 0; cnt < strJobNo.Length; cnt++)
        //                    //  {
        //                    //if (strJobNo[cnt].ToString().Trim() != string.Empty)

        //                    if (JobNo.Trim() != string.Empty)
        //                    {
        //                        dtJobExist = objNIA.ValidateControlNo(JobNo.ToString().Trim());
        //                        if (dtJobExist.Rows.Count > 0)
        //                        {
        //                            blnValid = true;
        //                        }
        ...
        //                        return Json(1);
        //        }
        //        else if (ActType.ToUpper() == "42")
        //        {
        //            if (JobNo.Trim() != string.Empty)
        //            {
        //                dtJobExist = objNIA.ValidateSalesOrderNo(JobNo.ToString().Trim());
        ...
        public JsonResult ValidateJob(string JobNo, string ActType)//Checking Existing User Name
        {
            ...
            try
            {
                /// if (ActType.ToUpper() == "PROJECT COORDINATION" || ActType.ToUpper() == "QA ACTIVITY - PROJECT")
                //if (ActType.ToUpper() == "10" || ActType.ToUpper() == "20")
                if (ActType.ToUpper() == "06" || ActType.ToUpper() == "16" || ActType.ToUpper() == "27" || ActType.ToUpper() == "44" || ActType.ToUpper() == "45" || ActType.ToUpper() == "43" || ActType.ToUpper() == "03" || ActType.ToUpper() == "47" || ActType.ToUpper() == "37")
                {
                    //   string[] strJobNo = JobNo.Split(',');
                    ...
                    {
                        dtJobExist = objNIA.ValidateControlNo(JobNo.ToString().Trim());
                        var status = dtJobExist.Rows[0]["status"].ToString();
                        if (!string.IsNullOrEmpty(status))  // If status is not empty
                        {
                            return Json(status);  
                        }
                        else
                ...
                else if (ActType.ToUpper() == "42")
                {
                    if (JobNo.Trim() != string.Empty)
                    {
                        ...
                        var status_ = dtJobExist.Rows[0]["status"].ToString();
                        if (!string.IsNullOrEmpty(status_))  // If status is not empty
                        {
                            return Json(status_);  
                        }
                        else
                ...
                else if (ActType.ToUpper() == "25" || ActType.ToUpper() == "07" || ActType.ToUpper() == "18" || ActType.ToUpper() == "28" || ActType.ToUpper() == "40")
                {

                    dtJobExist = objNIA.ValidateJob(JobNo.Trim(), ActType.ToUpper());
                    var status_ValidateJob = dtJobExist.Rows[0]["status"].ToString();
                    if (!string.IsNullOrEmpty(status_ValidateJob))  // If status is not empty
                    {
                        return Json(status_ValidateJob); 
                    }
                    else
                    {
                        if (dtJobExist.Rows.Count > 0)
        ...
        public JsonResult chkIfHoliday(string fromDate, string toDate)//Checking Existing User Name
        {
            string Result = string.Empty;
            DataTable DTExistRoleName = new DataTable();
            try
            {
                DTExistRoleName = objNIA.chkHoliday(fromDate, toDate);
                if (DTExistRoleName.Rows.Count > 0)
                {
                    return Json(1);
                }
        ...
        public JsonResult chkIfWeeklyOffEntered(string fromDate, string toDate)//Checking Existing User Name
        {
            string Result = string.Empty;
            DataTable DTExistRoleName = new DataTable();
            try
            {
                DTExistRoleName = objNIA.WeeklyOff(fromDate, toDate);
                if (DTExistRoleName.Rows.Count > 0)
                {
                    return Json(1);
                }
        ...
        public JsonResult chkIfSunday(string fromDate, string toDate)//Checking Existing User Name
        {
            string Result = string.Empty;
            DataTable DTExistRoleName = new DataTable();
            try
            {
                DTExistRoleName = objNIA.dtchkIfSunday(fromDate, toDate);
                if (DTExistRoleName.Rows.Count > 0)
                {
                    return Json(1);
                }
        ...
        [HttpPost]
        public ActionResult CreateNew(NonInspectionActivity R, int? Id)
        {
            string Result = string.Empty;
            try
            {
            ...
            return Json(new { result = "Redirect", url = Url.Action("NonInspectionActivity", "NonInspectionActivity", new { Id = Id }) });
