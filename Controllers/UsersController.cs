...
namespace TuvVision.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult CreateUser(string UserID)
        {
            ...
            //added by nikita 
            var nationality = objDalCreateUser.GetNationality();
            ViewBag.SubCatlist_nationality = new SelectList(nationality, "Nationality_ID", "Nationality_");
            ...
            var dtDocType = objDalCreateUser.GetDocumentType(LoginUserRoleId);
            ...
            //if (UserID != null)
            //{
            //    DSGetEmployeeType = objDalCreateUser.GetEmployeeTypeLst(UserID);
            //}
            //else
            //{
            ...
            if (UserID != "" && UserID != null)
            {
                ...
                if (DTEditUser.Rows.Count > 0)
                {
                    ...
                    ObjModelUsers.Dom_Inter = Convert.ToString(DTEditUser.Rows[0]["Inter_Domestic"]);
                    ViewBag.Status = Convert.ToString(DTEditUser.Rows[0]["Inter_Domestic"]);
                    ObjModelUsers.Nationality = Convert.ToInt32(DTEditUser.Rows[0]["Nationality"]);
                    ObjModelUsers.Location = Convert.ToString(DTEditUser.Rows[0]["Location"]);
                    ObjModelUsers.EmpRollNo = Convert.ToString(DTEditUser.Rows[0]["EmployeeRollNo"]);
                    ObjModelUsers.IBRcompetent = Convert.ToString(DTEditUser.Rows[0]["IBRCompetent"]);  //nikita on 13032025
                ...
                #region get ndt qualification data
                DataTable dtNdtCerts = new DataTable();
                List<NDTQualification> lstNdtCertificates = new List<NDTQualification>();

                string MTcertificationDate;
                string MTCertvalidTill;
                ...
                dtNdtCerts = objDalCreateUser.GetNdtCerts(ObjModelUsers.PK_UserID);
                if (dtNdtCerts.Rows.Count > 0)
                {

                    foreach (DataRow dr in dtNdtCerts.Rows)
                    {
                        string MT_Pass = Convert.ToString(dr["MT_Pass"]);
                        string PT_Pass = Convert.ToString(dr["PT_Pass"]);
                        string VT_Pass = Convert.ToString(dr["VT_Pass"]);
                        string UT_Pass = Convert.ToString(dr["UT_Pass"]);
                        string RT_Pass = Convert.ToString(dr["RT_Pass"]);
                        DateTime parseddate;
                        DateTime? RT_CertDate = DateTime.TryParse(dr["RT_Cert_Date"]?.ToString(), out parseddate)
                        ? parseddate
                        : (DateTime?)null;
                        DateTime? MT_CertDate = DateTime.TryParse(dr["MT_Cert_Date"]?.ToString(), out parseddate)
                        ? parseddate
                        : (DateTime?)null;
                        DateTime? PT_CertDate = DateTime.TryParse(dr["PT_Cert_Date"]?.ToString(), out parseddate)
                         ? parseddate
                         : (DateTime?)null;
                        DateTime? UT_CertDate = DateTime.TryParse(dr["UT_Cert_Date"]?.ToString(), out parseddate)
                         ? parseddate
                         : (DateTime?)null;
                        DateTime? VT_CertDate = DateTime.TryParse(dr["VT_Cert_Date"]?.ToString(), out parseddate)
                         ? parseddate
                         : (DateTime?)null;

                        if (MT_Pass == "Pass")
                        {
                            string NdtCertName = "Magnetic Particle Testing (MT)";
                            MTcertificationDate = Convert.ToDateTime(dr["MT_Cert_Date"]).ToString("dd/MM/yyyy");
                            ...
                            lstNdtCertificates.Add(new NDTQualification
                            {
                                NdtCertName = NdtCertName,
                                NdtCertDate = MTcertificationDate,
                                NdtValid = MTCertvalidTill
                            });
                        ...
                        if (PT_Pass == "Pass")
                        {
                            string NdtCertName = "Liquid Pentrant Testing (PT)";
                            PTcertificationDate = Convert.ToDateTime(dr["PT_Cert_Date"]).ToString("dd/MM/yyyy");
                            ...
                            {
                                NdtCertName = NdtCertName,
                                NdtCertDate = PTcertificationDate,
                                NdtValid = PTCertvalidTill
                            });

                        }
                        if (VT_Pass == "Pass")
                        {
                            string NdtCertName = "Visual Testing (VT)";
                            VTcertificationDate = Convert.ToDateTime(dr["VT_Cert_Date"]).ToString("dd/MM/yyyy");
                            ...
                            {
                                NdtCertName = NdtCertName,
                                NdtCertDate = VTcertificationDate,
                                NdtValid = VTCertvalidTill
                            });

                        }
                        if (UT_Pass == "Pass")
                        {
                            string NdtCertName = "Ultrasnoic Testing (PT)";
                            UTcertificationDate = Convert.ToDateTime(dr["UT_Cert_Date"]).ToString("dd/MM/yyyy");
                            ...
                            {
                                NdtCertName = NdtCertName,
                                NdtCertDate = UTcertificationDate,
                                NdtValid = UTCertvalidTill
                            });

                        }
                        if (RT_Pass == "Pass")
                        {
                            string NdtCertName = "Radiiography Testing (PT)";
                            RTcertificationDate = Convert.ToDateTime(dr["RT_Cert_Date"]).ToString("dd/MM/yyyy");
                            ...
                            {
                                NdtCertName = NdtCertName,
                                NdtCertDate = RTcertificationDate,
                                NdtValid = RTCertvalidTill
                            });

                        }
                    }
                    ViewBag.lstNdtCertificates = lstNdtCertificates;

                    Session["lstNdtCertificates"] = ViewBag.lstNdtCertificates;
                }
                #endregion
                ...
                dtAttach = objDalCreateUser.GetAtt(ObjModelUsers.UserPrimaryKey, ObjModelUsers.LoginUserRoleId);
                ...
                if (dtAttach.Rows.Count > 0)
                {
                    ...
                    TempData["DocAttachments"] = lstDTPAN;
                }
                #endregion
                    ...
                    foreach (DataRow dr in dtAttachEye.Rows)
                    {
                        lstDTPANEye.Add(
                           new Users
                           {
                               ...
                               FileName = Convert.ToString(dr["FileName"]),
                               AttType = Convert.ToString(dr["attType"]),
                               EyeIssueDate = Convert.ToString(dr["CertIssueDate"]),
                               //CertIssueDate = Convert.ToString(dr["CertIssueDate"]),
                               //CreatedBy = Convert.ToString(dr["CreatedBy"]),
                               //CertValidTill = Convert.ToString(dr["CertValidTill"]),
                               EyeCertName = Convert.ToString(dr["CertIssueDate"]),
                               EyeCreatedBy = Convert.ToString(dr["CreatedBy"]),
                               EyeValidTill = Convert.ToString(dr["CertValidTill"]),
                           }
                         );
                    }
        ...
        public ActionResult CreateCV()
        {
            ...
            List<Users> lstndt = new List<Users>();
            ...
            if (dtNdtCerts.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in dtNdtCerts.Rows)
                {
                    ...
                    string UT_Pass = Convert.ToString(dr["UT_Pass"]);
                    string RT_Pass = Convert.ToString(dr["RT_Pass"]);
                    DateTime MT_CertDate = Convert.ToDateTime(dr["MT_Cert_Date"]);
                    DateTime PT_CertDate = Convert.ToDateTime(dr["PT_Cert_Date"]);
                    DateTime RT_CertDate = Convert.ToDateTime(dr["RT_Cert_Date"]);
                    DateTime UT_CertDate = Convert.ToDateTime(dr["UT_Cert_Date"]);
                    DateTime VT_CertDate = Convert.ToDateTime(dr["VT_Cert_Date"]);

                    if (MT_Pass == "Pass")
                    {
                        string NdtCertName = "Magnetic Particle Testing (MT)";
                        MTcertificationDate = Convert.ToDateTime(dr["MT_Cert_Date"]).ToString("dd/MM/yyyy");
                        DateTime certValidTillDate = MT_CertDate.AddYears(5).AddDays(-1);
                        MTCertvalidTill = certValidTillDate.ToString("dd/MM/yyyy");

                        lstndt.Add(new Users
                        {
                            Method = NdtCertName,
                            CertDate = MTcertificationDate,
                            CertValidDate = MTCertvalidTill
                        });
                    }
                    if (PT_Pass == "Pass")
                    {
                        string NdtCertName = "Liquid Pentrant Testing (PT)";
                        PTcertificationDate = Convert.ToDateTime(dr["PT_Cert_Date"]).ToString("dd/MM/yyyy");
                        DateTime certValidTillDate = PT_CertDate.AddYears(5).AddDays(-1);
                        PTCertvalidTill = certValidTillDate.ToString("dd/MM/yyyy");

                        lstndt.Add(new Users
                        {
                            Method = NdtCertName,
                            CertDate = PTcertificationDate,
                            CertValidDate = PTCertvalidTill
                        });
                    ...
                    if (VT_Pass == "Pass")
                    {
                        string NdtCertName = "Visual Testing (VT)";
                        VTcertificationDate = Convert.ToDateTime(dr["VT_Cert_Date"]).ToString("dd/MM/yyyy");
                        DateTime certValidTillDate = VT_CertDate.AddYears(5).AddDays(-1);
                        VTCertvalidTill = certValidTillDate.ToString("dd/MM/yyyy");

                        lstndt.Add(new Users
                        {
                            Method = NdtCertName,
                            CertDate = VTcertificationDate,
                            CertValidDate = VTCertvalidTill
                        });
                    ...
                    if (UT_Pass == "Pass")
                    {
                        string NdtCertName = "Ultrasnoic Testing (PT)";
                        UTcertificationDate = Convert.ToDateTime(dr["UT_Cert_Date"]).ToString("dd/MM/yyyy");
                        DateTime certValidTillDate = UT_CertDate.AddYears(5).AddDays(-1);
                        UTCertvalidTill = certValidTillDate.ToString("dd/MM/yyyy");

                        lstndt.Add(new Users
                        {
                            Method = NdtCertName,
                            CertDate = UTcertificationDate,
                            CertValidDate = UTCertvalidTill
                        });
                    ...
                    if (RT_Pass == "Pass")
                    {
                        string NdtCertName = "Radiiography Testing (PT)";
                        RTcertificationDate = Convert.ToDateTime(dr["RT_Cert_Date"]).ToString("dd/MM/yyyy");
                        DateTime certValidTillDate = RT_CertDate.AddYears(5).AddDays(-1);
                        RTCertvalidTill = certValidTillDate.ToString("dd/MM/yyyy");

                        lstndt.Add(new Users
                        {
                            Method = NdtCertName,
                            CertDate = RTcertificationDate,
                            CertValidDate = RTCertvalidTill
                        });

                    }
                }

                ViewBag.LstNdt = lstndt;
                Session["lstNdt"] = ViewBag.LstNdt;
            }
            ...
            DataTable UserDetail_Loc_Nationality = new DataTable();
            UserDetail_Loc_Nationality = DSGetUserCV.Tables[6];
            Session["UserDetail_Loc_Nationality"] = UserDetail_Loc_Nationality;
            ...
            //ObjModelUsers.nationalities =Convert.ToString(EmploymentDetails.Rows[0]["Nationality"]);
            //ObjModelUsers.Location = Convert.ToString(EmploymentDetails.Rows[0]["Location"]);

            ObjModelUsers.nationalities = Convert.ToString(UserDetail_Loc_Nationality.Rows[0]["Nationality"]);
            ObjModelUsers.Location = Convert.ToString(UserDetail_Loc_Nationality.Rows[0]["Location"]);
        ...
        public ActionResult DownloadCV(string language, string Age, string TotalEXP, string Inspection, bool IsInspectionCheck, string ExpertiseSummary, string[][] EmploymentDetails, string[][] ProjectDetails, string[][] TrainingDetails)
        {
            ...
            body = body.Replace("[Nationality]", ObjModelUsers.nationalities);//"Indian");
            body = body.Replace("[Location]", ObjModelUsers.Location.ToString());
            ...
            List<Users> lstndtnew = new List<Users>();
            lstndtnew = Session["lstNdt"] as List<Users>;

            if (lstndtnew != null)
            {
                string ndtStr = string.Empty;
                foreach (var ndt in lstndtnew)
                {
                    string Certification = ndt.Method;
                    string validTill = ndt.CertValidDate;

                    ndtStr = ndtStr + "<div class=\"col-md-12 row\">" + Certification + " (Valid till " + validTill + ")</div>";
                }

                body = body.Replace("[NdtCertification]", ndtStr);
            }
            else
            {
                body = body.Replace("[NdtCertification]", "");
            }
            ...
            string ReportName = "TUVIPL " + ObjModelUsers.Location + " " + ObjModelUsers.FullName + ".pdf";
                    ...
                    if (Result != "" && Result != null)
                    {
                        ...
                        if (DArrayEYE != null)
                        {
                            foreach (var d in DArrayEYE)
                            {
                                ...
                                URS.PK_ID = d.PK_ID;
                                URS.EyeCreatedBy = d.EyeCreatedBy;
                                URS.EyeIssueDate = d.EyeIssueDate;
                                //URS.CertValidTill = d.CertValidTill;
   ...
   */
        ...
        */
        ...
        private IGrid<ProfileUser> CreateExportableGrid(ProfileUser c)
        {
            ...
            grid.Columns.Add(model => model.PQS).Titled("PQS");
        ...
        public JsonResult InsertDocument(string DocType, string UserID, string Year)
        {
            ...
            try
            {
                ...
                {
                    if ((DocType == "1" || DocType == "2") && DOCUploaded.Count > 1)
                    {
                        Session["DocsUploaded"] = null;
                        return Json(new { result = "Ony One Attachment is allowed For Photo or Signature" });
                    }
                ...
                int loginid = Convert.ToInt32(Session["RoleID"]);
                dtAttach = objDalCreateUser.GetAtt(intUserID.ToString(), loginid);
                if (dtAttach.Rows.Count > 0)
                {
                    foreach (DataRow dr in dtAttach.Rows)
                    {
                    ...
                    foreach (DataRow dr in dtAttachEye.Rows)
                    {
                        lstDTPANEye.Add(
                           new Users
                           {
                               ...
                               Year = Convert.ToString(dr["CertIssueDate"]),
        ...
        [HttpPost]
        public ActionResult InsertCV(string Inspection, string ExpertiseSummary, bool IsInspectionCheck, string[][] EmploymentDetails, string[][] ProjectDetails, string[][] TrainingDetails, string[][] AchievementDetails, string[][] NdtDetails)
        {
            try
            {
                ...
                //DataTable Ndtdata1 = CerConvertToDataTable(NdtDetails);
        ...
        static DataTable CerConvertToDataTable(string[][] stringArray)
        {
            DataTable dataTable = new DataTable();
            ...
            if (stringArray.Length > 0)
            {
                ...
                foreach (string header in stringArray[0])
                {
                    if (!string.IsNullOrEmpty(header) && header != "Edit" && header != "Delete")
                    {
                        dataTable.Columns.Add(header.Replace(" ", "").Trim()); // Trim to avoid mismatch
                    }
                }
                ...
                for (int i = 1; i < stringArray.Length; i++)
                {
                    ...
                    for (int j = 0; j < stringArray[i].Length; j++) // Ensure all columns are processed
                    {
                        string cellValue = stringArray[i][j]?.Trim(); // Handle nulls and trim spaces

                        if (!string.IsNullOrEmpty(cellValue))
                        {
                            row[j] = cellValue; // ✅ Store value as a string, including date fields
                        }
                        else
                        {
                            row[j] = DBNull.Value; // Handle empty values
                        }
                    }

                    // Ensure at least one column has data before adding the row
                ...
                var headers = new Dictionary<string, string>()
{
    ...
    {"Cert173", "ARAMCO approved Inspector"},
        ...
        public ActionResult ExportJobsToExcel()
        {
            // Get the dataset from the method you provided
            DataTable dt = GetJOBList();

            // Create an Excel package using EPPlus
            using (ExcelPackage excelPackage = new ExcelPackage())
            {
                // Create a new worksheet in the Excel workbook
                ExcelWorksheet worksheet = excelPackage.Workbook.Worksheets.Add("Job List");
                ...
                return File(excelData, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "CallList.xlsx");
            }
        }
        ...
        public DataTable GetJOBList()//Get All DropDownlist 
        {
            ...
            try
            {
                ...
                CMDGetDdlLst.CommandTimeout = 120;
                CMDGetDdlLst.Parameters.AddWithValue("@SP_Type", "151");
        ...
        public ActionResult CreateAllUser()
        {
            return View();
        }
        ...
        public ActionResult GenerateTrainingDataExcel(string InspectorName)
        {
            try
            {   
                DataSet dsHtml = objDalCreateUser.GetDataExcel(InspectorName);
                using (var excelPackage = new ExcelPackage())
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add("Sheet1");
                    sheet.Cells["A1:G1"].Merge = true;
                    var titleCell = sheet.Cells["A1"];
                    titleCell.Value = "Training Record |F|13|05|Tiimes DTD.01.06.25";
                    ...
                    sheet.Cells["B2"].Value = dsHtml.Tables[0].Rows[0]["Name"].ToString();
                    sheet.Cells["A3"].Value = "Branch";
                    sheet.Cells["B3"].Value = dsHtml.Tables[0].Rows[0]["Branch_name"].ToString();
                    sheet.Cells["A4"].Value = "Designation";
                    sheet.Cells["B4"].Value = dsHtml.Tables[0].Rows[0]["Designation"].ToString();
                    sheet.Cells["A5"].Value = "Downloaded On";
                    sheet.Cells["B5"].Value = DateTime.Today.ToString("dd-MMM-yyyy");                   
                    for (int row = 2; row <= 5; row++)
                    {
                        var labelCell = sheet.Cells["A" + row];
                    ...
                    string[] headers = {
                    "Date", "Scope", "Scope Name", "Training Type",
                    "Training Category", "Training Topic", "Training Hours"
                };

                    for (int i = 0; i < headers.Length; i++)
                    {
                        var headerCell = sheet.Cells[7, i + 1];
                    ...
                    int startRow = 8;
                    DataTable dt = dsHtml.Tables[0];
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        sheet.Cells[startRow + i, 1].Value = dt.Rows[i]["TrainingStartDate"].ToString();
                        sheet.Cells[startRow + i, 2].Value = dt.Rows[i]["Scope"].ToString();
                        sheet.Cells[startRow + i, 3].Value = dt.Rows[i]["ScopeNumber"].ToString();
                        sheet.Cells[startRow + i, 4].Value = dt.Rows[i]["Type"].ToString();
                        sheet.Cells[startRow + i, 5].Value = dt.Rows[i]["Category"].ToString();
                        sheet.Cells[startRow + i, 6].Value = dt.Rows[i]["TrainingTopic"].ToString();
                        sheet.Cells[startRow + i, 7].Value = dt.Rows[i]["TotalHours"].ToString();                        
                        using (var range = sheet.Cells[startRow + i, 1, startRow + i, 7])
                        {
