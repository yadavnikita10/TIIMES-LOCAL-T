...
{
    public class UserDetailDashboardController : Controller
    {
        ...
        public ActionResult UserDashBoard()
        {
            ...
            DTUserDashBoard = objDalCreateUser.GetUserMis_();
            try
            {
                    ...
                    foreach (DataRow dr in DTUserDashBoard.Rows)
                    {
                        lstUserDashBoard.Add(
                            new ProfileUser
                            {
                                ...
                                //FK_RoleID = Convert.ToString(dr["RoleName"]),
                                ...
                                //EyeTest = Convert.ToString(dr["Year"]),
                                //OfficeNo = Convert.ToString(dr["OfficeNo"]),
                                //Reporting_Person_One = Convert.ToString(dr["Reporting_Person_One"]),
                                //PFUANNumber = Convert.ToString(dr["PFUANNumber"]),
                                //currentAssignment = Convert.ToString(dr["CurrentAssignment"]),
                                //IsLocked = Convert.ToString(dr["ProfileLocked"]),
                                ...
                                //LanguageSpoken = Convert.ToString(dr["LanguageSpoken"]),
                                //Dateofbirth = Convert.ToString(dr["DOB"]),
                                //ResidenceNo = Convert.ToString(dr["ResidenceNo"]),
                                //Medical_History = Convert.ToString(dr["Medical_History"]),
                                //ProfCertificates = Convert.ToString(dr["ProffesionalDetails"]),
                                ...
                                //Allergies = Convert.ToString(dr["Allergies"]),
                                ...
                                //OtherUniversity = Convert.ToString(dr["OtherUniversity"]),
                                //LastYearPerc = Convert.ToString(dr["LastYearPerc"]),
                                ...
                                //CertValidDate = Convert.ToString(dr["CertValidDate"]),
                                //certNo = Convert.ToString(dr["certNo"]),

                                //PortfolioAccess = Convert.ToString(dr["PortfolioAccess"]),
                                //UploadedDocument = Convert.ToString(dr["UploadedDocument"]),
                                ...
                                PortfolioAccess = Convert.ToString(dr["PortfolioAccess"]),
                                //UploadedDocument = Convert.ToString(dr["UploadedDocument"]),
                                //PK_id = Convert.ToString(dr["PK_ID"]),
                                Fk_UserId = Convert.ToString(dr["Fk_UserId"]),
        ...
        public ActionResult CreateUser(string UserID)
        {
            ...
            if (UserID != "" && UserID != null)
            {
                ...
                dtAttach = objDalCreateUser.GetAtt(ObjModelUsers.UserPrimaryKey, LoginUserRoleId);
   ...
   */
        ...
        */
        ...
        private IGrid<ProfileUser> CreateExportableGrid(ProfileUser c)
        {
            ...
            //grid.Columns.Add(model => model.Reporting_Person_One).Titled("Reporting_Person_One");
            //grid.Columns.Add(model => model.ReportingTwo).Titled("Reporting_Person_Two");
            //grid.Columns.Add(model => model.OPE).Titled("Eligible for OPE");
            grid.Columns.Add(model => model.Designation).Titled("Designation");
            grid.Columns.Add(model => model.TuvEmailId).Titled("TUV Email-ID");
            //grid.Columns.Add(model => model.OrgChangeDate).Titled("OrgChangeDate");
            //grid.Columns.Add(model => model.ReasonForUpdate).Titled("ReasonForUpdate");
            grid.Columns.Add(model => model.MainBranch).Titled("Main Branch");
            grid.Columns.Add(model => model.OBSTYPE).Titled("OBS Type");
            //grid.Columns.Add(model => model.PK_UserID).Titled("TIIMES UIN");
            //grid.Columns.Add(model => model.UserRole).Titled("Role");
            //grid.Columns.Add(model => model.PortfolioAccess).Titled("Portfolio Access");

            //grid.Columns.Add(model => model.ActiveStatus).Titled("Status");
            //grid.Columns.Add(model => model.IsLocked).Titled("Profile Locked");
            grid.Columns.Add(model => model.DOB).Titled("Date Of Birth");

            //grid.Columns.Add(model => model.PFUANNumber).Titled("PF-UAN Number");
            //grid.Columns.Add(model => model.PAN).Titled("Pan");
            //    grid.Columns.Add(model => model.AadharNo).Titled("AadharNo");
            grid.Columns.Add(model => model.Email).Titled("Personal Email ID");
            ...
            //grid.Columns.Add(model => model.Marital_Status).Titled("Marital Status");
            //grid.Columns.Add(model => model.LanguageSpoken).Titled("LanguageSpoken");
            ...
            //grid.Columns.Add(model => model.Medical_History).Titled("Medical History");
            //grid.Columns.Add(model => model.Allergies).Titled("Allergies");
            ...
            grid.Columns.Add(model => model.Course).Titled("Course");
            grid.Columns.Add(model => model.Degree).Titled("Degree");
            grid.Columns.Add(model => model.MajorFieldOfStudy).Titled("Field of study");
            ...
            grid.Columns.Add(model => model.certNo).Titled("Issue Date");
            grid.Columns.Add(model => model.CertIssueDate).Titled("Issue Date");
    
            grid.Columns.Add(model => model.CertValidDate).Titled("Valid Till");

            grid.Columns.Add(model => model.EyeTest).Titled("Eye Test Year");
            //grid.Columns.Add(model => model.UploadedDocument).Titled("Uploaded Document");
